...
@NgModule({
  declarations: [InstallationsComponent, ListingComponent, MapComponent, MeasurementsComponent, AnalyseComponent, AlarmsComponent, ReportsComponent, SettingsComponent],
  imports: [
    CommonModule,
